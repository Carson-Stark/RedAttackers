...
public class gunUpScreen : MonoBehaviour {
	...
	void Start () {
		...
		transform.Find ("defenceType").GetComponent<Text>().text = "Gun:";
		transform.Find ("level").GetComponent<Text>().text = "Level " + ups.level.ToString();
		
		
		switch (ups.level) {
		case 1:
			stats.GetChild (0).GetComponent<Text>().text = "Scatter: " + ups.up1 [0];
		...
		case 2:
			stats.GetChild (0).GetComponent<Text>().text = "Scatter: " + ups.up2 [0];
			...
			transform.Find ("description").GetComponent<Text>().text = ups.dis[1];
			transform.Find ("price").GetComponent<Text>().text = "$" + ups.price[1];
			break;
			
		case 3:
			stats.GetChild (0).GetComponent<Text>().text = "Scatter: " + ups.up3 [0];
			...
			transform.Find ("description").GetComponent<Text>().text = ups.dis[2];
			transform.Find ("price").GetComponent<Text>().text = "$" + ups.price[2];
			break;
			
		case 4:
			stats.GetChild (0).GetComponent<Text>().text = "Scatter: " + ups.up4 [0];
			...
			transform.Find ("description").GetComponent<Text>().text = ups.dis[3];
			transform.Find ("price").GetComponent<Text>().text = "$" + ups.price[3];
			break;
			
		case 5:
			stats.GetChild (0).GetComponent<Text>().text = "Scatter: " + ups.up5 [0];
			stats.GetChild (0).GetChild (0).GetComponent<Text>().text = ups.up5 [0];
			...
			transform.Find ("description").GetComponent<Text>().text = ups.dis[4];
