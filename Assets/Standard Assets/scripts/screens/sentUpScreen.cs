...
public class sentUpScreen : MonoBehaviour {
	...
	void Start () {
		...
		transform.Find ("defenceType").GetComponent<Text>().text = "Sentry:";
		...
		case 1:
			...
			stats.GetChild (1).GetComponent<Text>().text = "Cannon Damage: " + ups.up1[1];
			stats.GetChild (1).GetChild (0).GetComponent<Text>().text = "+ " + ups.up2[1];
			stats.GetChild (2).GetComponent<Text>().text = "Cannon Cooldown: " + ups.up1[2];
			stats.GetChild (2).GetChild (0).GetComponent<Text>().text = "- " + ups.up2[2];
			stats.GetChild (3).GetComponent<Text>().text = "Turret Damage: " + ups.up1[3];
			stats.GetChild (3).GetChild (0).GetComponent<Text>().text = "+ " + ups.up2[3];
			stats.GetChild (4).GetComponent<Text>().text = "Turret Cooldown: " + ups.up1[4];
			stats.GetChild (4).GetChild (0).GetComponent<Text>().text = "- " + ups.up2[4];
		...
		case 2:
			...
			stats.GetChild (1).GetComponent<Text>().text = "Cannon Damage: " + ups.up2[1];
			stats.GetChild (1).GetChild (0).GetComponent<Text>().text = "+ " + ups.up3[1];
			stats.GetChild (2).GetComponent<Text>().text = "Cannon Cooldown: " + ups.up2[2];
			stats.GetChild (2).GetChild (0).GetComponent<Text>().text = "- " + ups.up3[2];
			stats.GetChild (3).GetComponent<Text>().text = "Cannon Damage: " + ups.up1[3];
			stats.GetChild (3).GetChild (0).GetComponent<Text>().text = "+ " + ups.up2[3];
			stats.GetChild (4).GetComponent<Text>().text = "Cannon Cooldown: " + ups.up1[4];
			stats.GetChild (4).GetChild (0).GetComponent<Text>().text = "- " + ups.up2[4];
		...
		case 3:
			...
			stats.GetChild (1).GetComponent<Text>().text = "Cannon Damage: " + ups.up3[1];
			stats.GetChild (1).GetChild (0).GetComponent<Text>().text = "+ " + ups.up4[1];
			stats.GetChild (2).GetComponent<Text>().text = "Cannon Cooldown: " + ups.up3[2];
		...
		case 4:
			...
			stats.GetChild (1).GetComponent<Text>().text = "Cannon Damage: " + ups.up4[1];
			stats.GetChild (1).GetChild (0).GetComponent<Text>().text = "+ " + ups.up5[1];
			stats.GetChild (2).GetComponent<Text>().text = "Cannon Cooldown: " + ups.up4[2];
		...
		case 5:
			...
			stats.GetChild (0).GetChild (0).GetComponent<Text>().text = "+ " + ups.up5[0];
			stats.GetChild (1).GetComponent<Text>().text = "Cannon Damage: " + ups.up5[1];
			stats.GetChild (1).GetChild (0).GetComponent<Text>().text = "+ " + ups.up5[1];
			stats.GetChild (2).GetComponent<Text>().text = "Cannon Cooldown: " + ups.up5[2];
			stats.GetChild (2).GetChild (0).GetComponent<Text>().text = "- " + ups.up5[2];
			stats.GetChild (3).GetComponent<Text>().text = "Cannon Damage: " + ups.up1[3];
			stats.GetChild (3).GetChild (0).GetComponent<Text>().text = "+ " + ups.up2[3];
			stats.GetChild (4).GetComponent<Text>().text = "Cannon Cooldown: " + ups.up1[4];
